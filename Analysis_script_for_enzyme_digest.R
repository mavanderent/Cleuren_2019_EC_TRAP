### Ribo analysis
### Comparison of the Tie2_Cre with enzyme digest 
### version 03_30_2019
...
setwd("$PATH")
dat    <- read.csv("02_02-19_original_SC_RPKM.csv", header = TRUE, row.names = 1)

### load metadata
setwd("$PATH")
info   <- read.csv("02_02_19_original_SC_samples.csv", header = TRUE, row.names = 1)
...
setwd("$PATH")
write.csv(ratio,"03_30_2019_analysis_SC_ratio.csv")
rm(n1,p)
...
setwd("$PATH")
write.csv(input,"03_30_2019_analysis_SC_input.csv")
rm(n1,p)
...
setwd("$PATH")
write.csv(bead,"03_30_2019_analysis_SC_bead.csv")
rm(n1,p)
