### Ribo analysis
### Comparison of the Tie2-Cre with ubiquitous EIIa-Cre driver
### version 04_02_2019
rm(list=ls())
...
setwd("$PATH")
dat    <- read.csv("03_02_19_EIIa_RPKM.csv", header = TRUE, row.names = 1)

### load metadata
info   <- read.csv("03_02_19_EIIa_samples.csv", header = TRUE, row.names = 1)
...
write.csv(ratio,"04_02_2019_analysis_EIIa_ratio.csv")
rm(n1,p)
...
write.csv(input,"04_02_2019_analysis_EIIa_input.csv")
rm(n1,p)
...
write.csv(bead,"04_02_2019_analysis_EIIa_bead.csv")
rm(n1,p)
